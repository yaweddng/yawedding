...
async function startServer() {
  ...
  app.get("/manifest.json", (req, res) => {
    ...
    let manifest = {
      ...
      icons: [
        {
          src: "data:image/svg+xml;base64,",
          sizes: "192x192",
          type: "image/svg+xml",
